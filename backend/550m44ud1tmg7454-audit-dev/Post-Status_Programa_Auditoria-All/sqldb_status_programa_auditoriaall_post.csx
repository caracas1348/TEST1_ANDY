...
class DataStatus_Programa_AuditoriaAll
{
   
    public async Task<long> funPostStatus_Programa_AuditoriaAll(ILogger log, status_programa_auditoriaall curentity)
    {
        ...
        status_programa_auditoriaall curobj;
        string vvcomodin="";

        curobj = new status_programa_auditoriaall();
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                var textselectpart1 = "INSERT INTO auditoria.Status_Programa_Auditoria (  ";
    ...
    public status_programa_auditoriaall funPutStatus_Programa_AuditoriaAll(ILogger log,long curid, status_programa_auditoriaall curentity )
    {
    ...
    try{
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Status_Programa_Auditoria SET ";
...
public long funDeleteStatus_Programa_AuditoriaAll(ILogger log,long curid, string usuariodelete)
{
    ...
    try{
     ...
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Status_Programa_Auditoria ";
...
public class status_programa_auditoriaall
{
