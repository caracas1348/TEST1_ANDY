...
class DataTipo_AuditoriaAll
{
    ...
    public async Task<long> funPostTipo_AuditoriaAll(ILogger log, tipo_auditoriaall curentity)
    {
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                var textselectpart1 = "INSERT INTO auditoria.Tipo_Auditoria (  ";
    ...
    public tipo_auditoriaall funPutTipo_AuditoriaAll(ILogger log,long curid, tipo_auditoriaall curentity )
    {
    ...
    try{
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Tipo_Auditoria SET ";
...
public long funDeleteTipo_AuditoriaAll(ILogger log,long curid, string usuariodelete)
{
    ...
    try{
     ...
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Tipo_Auditoria ";
