...
class DataAuditoria_NormaAll
{
   
    public async Task<long> funPostAuditoria_NormaAll(ILogger log, auditoria_normaall curentity)
    {
        ...
        auditoria_normaall curobj;
        string vvcomodin="";

        curobj = new auditoria_normaall();
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                var textselectpart1 = "INSERT INTO auditoria.Auditoria_Norma (  ";
                var textselectpart2 = " output INSERTED.ID VALUES( ";
                textselectpart1 = textselectpart1 + " Deleted ";
                ...
                if( curentity.NormaCode != null)
                { textselectpart1 = textselectpart1 + ",NormaCode";
                    textselectpart2 = textselectpart2 + ",@NormaCode";
                }
                ...
                {  
                    ...
                    if( curentity.NormaCode != null) cmd.Parameters.AddWithValue("@NormaCode", curentity.NormaCode);
    ...
    public auditoria_normaall funPutAuditoria_NormaAll(ILogger log,long curid, auditoria_normaall curentity )
    {
    ...
    try{
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Auditoria_Norma SET ";
       var textselectpart2 = " WHERE 1=1 AND Id = @Id  ";
       textselectpart1 = textselectpart1 + " Deleted = 0 ";
       ...
       if( curentity.NormaCode != null)
       { textselectpart1 = textselectpart1 + ", NormaCode = @NormaCode";  }
         textselectpart2 = textselectpart2 + " ; ";
...
public long funDeleteAuditoria_NormaAll(ILogger log,long curid, string usuariodelete)
{
    ...
    try{
     ...
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "DELETE FROM auditoria.Auditoria_Norma ";
...
public class auditoria_normaall
{
