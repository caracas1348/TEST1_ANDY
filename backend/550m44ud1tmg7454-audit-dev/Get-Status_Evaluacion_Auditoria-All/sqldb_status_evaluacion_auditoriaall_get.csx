...
class DataStatus_Evaluacion_AuditoriaAll
{
    public List<status_evaluacion_auditoriaall> funGetStatus_Evaluacion_AuditoriaAllList(ILogger log, int vnsearch_type
                                                    , int vnid
                                                    ...
                                                    )
    {
        ...
        //Lista de Objetos
        List<status_evaluacion_auditoriaall> lobjs = new List<status_evaluacion_auditoriaall>();
        status_evaluacion_auditoriaall curobj;
        string vvcomodin="";
        //SQL Objects
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                if(vnsearch_type == 1)
                { vvcomodin= "%";   }                 
                var textselect = "SELECT * FROM auditoria.Status_Evaluacion_Auditoria WHERE 1 = 1 ";
                if(vnid != 0)
                ...
                using (SqlCommand cmd = new SqlCommand(StrQuery, conn))
                {
                    ...
                    {   
                        ...
                        {
                            curobj                                                  = new status_evaluacion_auditoriaall();                    
...
public class status_evaluacion_auditoriaall
{
