#r "Newtonsoft.Json"
#load "sqldb_tipo_hallazgosall_get.csx"
...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    DataTipo_HallazgosAll vobj_sqldata = new DataTipo_HallazgosAll();
    string jsonrspt = "";
    //Evaluar Clave API
    ...
    {                                                                                                                                                                                                              
        List<tipo_hallazgosall> lobjs = vobj_sqldata.funGetTipoHallazgoAllList(log);
