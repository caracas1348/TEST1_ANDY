#r "Newtonsoft.Json"
#load "sqldb_auditoria_normaall_get.csx"
...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    string vvnormacode              = req.Query["NormaCode"];
    ...
    {                                                                                                                                                                                                              
        List<auditoria_normaall> lobjs = vobj_sqldata.funGetAuditoria_NormaAllList(log
                                                                , vnsearch_type
                                                                , vnid 
                                                                , vnauditoriaid
                                                                , vvnormacode
