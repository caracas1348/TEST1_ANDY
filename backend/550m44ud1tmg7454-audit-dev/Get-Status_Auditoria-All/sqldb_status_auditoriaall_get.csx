...
class DataStatus_AuditoriaAll
{
    public List<status_auditoriaall> funGetStatus_AuditoriaAllList(ILogger log, int vnsearch_type
                                                    , int vnid
                                                    ...
                                                    )
    {
        ...
        //Lista de Objetos
        List<status_auditoriaall> lobjs = new List<status_auditoriaall>();
        status_auditoriaall curobj;
        string vvcomodin="";
        //SQL Objects
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                if(vnsearch_type == 1)
                { vvcomodin= "%";   }                 
                var textselect = "SELECT * FROM auditoria.Status_Auditoria WHERE 1 = 1 ";
                if(vnid != 0)
                ...
                using (SqlCommand cmd = new SqlCommand(StrQuery, conn))
                {
                    ...
                    {   
                        ...
                        {
                            curobj                                                  = new status_auditoriaall();                    
...
public class status_auditoriaall
{
