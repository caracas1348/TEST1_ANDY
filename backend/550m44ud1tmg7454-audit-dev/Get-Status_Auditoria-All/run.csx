#r "Newtonsoft.Json"
#load "sqldb_status_auditoriaall_get.csx"
...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    DataStatus_AuditoriaAll vobj_sqldata = new DataStatus_AuditoriaAll();
    string jsonrspt = "";
    //Evaluar Clave API
    ...
    {                                                                                                                                                                                                              
        List<status_auditoriaall> lobjs = vobj_sqldata.funGetStatus_AuditoriaAllList(log
                                                                , vnsearch_type
                                                                , vnid    
                                                                , vvdescription
                                                                , vnactive
