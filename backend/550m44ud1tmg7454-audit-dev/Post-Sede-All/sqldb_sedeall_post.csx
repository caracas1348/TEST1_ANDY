...
class DataSedeAll
{
    ...
    public async Task<long> funPostSedeAll(ILogger log, sedeall curentity)
    {
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                var textselectpart1 = "INSERT INTO auditoria.Sede (  ";
                ...
                if( curentity.UnidadNegocioId !=0)
                { textselectpart1 = textselectpart1 + ",UnidadNegocioId"; 
                    textselectpart2 = textselectpart2 + ",@UnidadNegocioId";
                }
                ...
                {  
                    ...
                    if( curentity.UnidadNegocioId !=0) cmd.Parameters.AddWithValue("@UnidadNegocioId", curentity.UnidadNegocioId);
    ...
    public sedeall funPutSedeAll(ILogger log,long curid, sedeall curentity )
    {
    ...
    try{
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Sede SET ";
       ...
       if( curentity.UnidadNegocioId != 0)
       { textselectpart1 = textselectpart1 + ", UnidadNegocioId = @UnidadNegocioId ";  }
       if( curentity.Active != 0)
...
public long funDeleteSedeAll(ILogger log,long curid, string usuariodelete)
{
    ...
    try{
     ...
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Sede ";
