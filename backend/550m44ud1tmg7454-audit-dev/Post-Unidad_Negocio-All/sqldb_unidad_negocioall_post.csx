...
class DataUnidad_NegocioAll
{
    ...
    public async Task<long> funPostUnidad_NegocioAll(ILogger log, unidad_negocioall curentity)
    {
        ...
        try{
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                var textselectpart1 = "INSERT INTO auditoria.Unidad_Negocio (  ";
                ...
                if( curentity.Id != null && curentity.Id !=0)
    ...
    public unidad_negocioall funPutUnidad_NegocioAll(ILogger log,long curid, unidad_negocioall curentity )
    {
    ...
    try{
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Unidad_Negocio SET ";
...
public long funDeleteUnidad_NegocioAll(ILogger log, long curid, string usuariodelete)
{
    ...
    try{
     ...
     using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
     {
       ...
       //Start - Manejo de Parametros
       var textselectpart1 = "UPDATE auditoria.Unidad_Negocio ";
