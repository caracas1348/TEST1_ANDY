...
*
* DESCRIPCION: ARCHIVO RUN BACKEND DE FUNCIONALIDAD EN SERVIDOR DEL LISTADO E INFORMACION --run 29
...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    long IdTipoEvento          = req.Query["IdTipoEvento"] == "" ? 0 : System.Convert.ToInt64(req.Query["IdTipoEvento"]);//Id Incidete
    ...
    if (vvhttpmethod == "imagenes")
    {
        DataPlanAnual curobj = new DataPlanAnual();
        long Id = 0;
        curobj = await vobj_sqldata.funGetPlanAnualAllList2( log
                                                            , Id
                                                            , IdTipoEvento   //Tipo Evento
                                                            , IdEmpresa   //IdEmpresa
                                                            , IdSede       // Sede
