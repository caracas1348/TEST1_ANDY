...
public static async void Run(TimerInfo daemon, ILogger log)
{
    ...
    log.LogInformation("demonio de notificacion de inspeccion asignada");
    log.LogInformation($"C# Timer trigger function executed at: {DateTime.Now}");
    var url                     = "https://550m44ud1tmg7454-inspection-dev.azurewebsites.net/api/Post-Inspection?code=jKg6Aw0QHRBr2DbAVfg9hpJrLFsxqc3uGtrjOol8bT/SebTkMsMziA==&httpmethod=assignNotification";
