    ...
    public async Task<DataPlanAnual> funGetPlanAnualAllList( ILogger log , long Id, long IdTipoEvento, long IdEmpresa, long IdSede, string FechaInicio, string FechaFin, long IdEmbarcacion)
    {
        ...
        try
        {
            ...
            using (SqlConnection conn = new SqlConnection(vvsqlconnectionString))
            {
                ...
                SqlCommand cmd = new SqlCommand("[ssoma].[a_get_lista_datos_generales_incidente]", conn);//legue hasta aqui andy
                ...
                using (SqlDataReader dataReader = await cmd.ExecuteReaderAsync())
                {
                    ...
                    while (dataReader.Read())
                    {
                          ...
                          if (!dataReader.IsDBNull(dataReader.GetOrdinal("TemporadaVeda"))) { curobj.TemporadaVeda = (long)(dataReader.GetValue(dataReader.GetOrdinal("TemporadaVeda"))); }//ya  //TemporadaVeda
