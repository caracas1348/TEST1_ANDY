...
* | 1 | Andy Vásquez    |  |  14/06/2021  |  | 16:00:50 |    caracas1348@gmail.com   | post - run 001
...
*              LOS INCIDENTES ACCIDENTES MATERIALES DESDE LA WEB
*
...
public static EvidenciaPost funsetObjectEvidencia(ILogger log, dynamic dataobject, string vvmethod)
{
    ...
    {//-----------------------------------------------------------------------------------------------------
        log.LogInformation("en  vvmethod == post.......................");
          ...
          curobj.fecha_Descanso_Fin     =                       dataobject?.fecha_Descanso_Fin;    log.LogInformation("curobj.fecha_Descanso_Fin = "+curobj.fecha_Descanso_Ini );

          curobj.fecha_Descanso_Ini     =                       dataobject?.fecha_Descanso_Ini;    log.LogInformation("curobj.fecha_Descanso_Ini = "+curobj.fecha_Descanso_Ini );
          ...
          curobj.NombreEquipo           =                       dataobject?.NombreEquipo;          log.LogInformation("curobj.NombreEquipo = "+curobj.NombreEquipo );
