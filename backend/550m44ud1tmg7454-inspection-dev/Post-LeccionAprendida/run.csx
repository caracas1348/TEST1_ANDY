...
* | 1 | Andy Vásquez    |  |  26/03/2021  |  | 09:00:50 |    caracas1348@gmail.com   | post - run 006
...
public static EvidenciaPost funsetObjectEvidencia(ILogger log, dynamic dataobject, string vvmethod)
{
    ...
    {//-----------------------------------------------------------------------------------------------------
        log.LogInformation("en  vvmethod == post.......................");
          ...
          //-------------------------------------------------------------------------------------------------------------------------------------------
                      curobj.IdIncidente1 =                           dataobject?.IdIncidente1;     log.LogInformation("curobj.Id1 = "+curobj.IdIncidente1);
                      curobj.IdTipoEvento_ =                          dataobject?.IdTipoEvento_; /*---------------*/
                      curobj.IdSede =                                 dataobject?.IdSede; /*---------------*/
                      curobj.Fecha =                                  dataobject?.Fecha; /*---------------*/
                      curobj.FraseCorta =                             dataobject?.FraseCorta; /*---------------*/
                      curobj.Descripcion =                            dataobject?.Descripcion; /*---------------*/
                      curobj.Codigo =                                 dataobject?.Codigo; /*---------------*/
                      curobj.TipoDatoGeneral =                        dataobject?.TipoDatoGeneral; /*---------------*/
                      curobj.Potencial =                              dataobject?.Potencial; /*---------------*/
                      curobj.TipoLesionDanio =                        dataobject?.TipoLesionDanio; /*---------------*/
                      curobj.Mortal =                                 dataobject?.Mortal; /*---------------*/
                      curobj.Create_By =                              dataobject?.Create_By; /*---------------*/
                      curobj.Create_Date =                            dataobject?.Create_Date; /*---------------*/
                      curobj.B_Contaminante =                         dataobject?.B_Contaminante; /*---------------*/
                      curobj.B_Impacto_Ambiental =                    dataobject?.B_Impacto_Ambiental; /*---------------*/
