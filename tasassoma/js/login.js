    ...
    var init = function()
    {
        ...
        $('#fm_login').submit(function() {
            ...
            if(usuario.trim().length==0){
                ...
                $(".spinner-grow").show();
                var url = apiurlsecurity+"/api/AuthUserSystem?httpmethod=auth&system_code="+constantes.sysCode+"&code="+AuthUserSystem+"";
                var headers ={
                    ...
                    $("#sedeHeader").hide();
                        ...
                        if(data.length>0)
                        {
                            ...
                            data.map(item=>{
                                ...
                                if(item.urlpath)
                                {
                                    if(item.urlpath=='view/ssoma/menu.html' || item.urlpath=='view/auditoria/menu.html')
                                    {
