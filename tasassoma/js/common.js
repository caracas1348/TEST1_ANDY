...
function atrasBack()/*esta funcion debe ejecutarse en el evento onclick del  <div id="regresar"*/
{//-----ini-------------------- se encargara de enviar desde la pagina actual a la anterior ruta de navegacion -----@andy-------------
...
function showOriginCall(value)
{
  var origenInicial = $("#txOrigenRequest").val();
    if(value=="sereno")
    {
      $("#txOrigenRequest").val(1);tipoLlamada=1;
  ...
  if(tx!="")
  {
    if(regexcam.exec(tx))
    {
      $("#txOrigenRequest").val(2); tipoLlamada=2;
    }
    ...
    {
      $("#txOrigenRequest").val(3);tipoLlamada=3;
    }
    else
    {
      tipoLlamada=null;
...
//alert(timeZone)
  ...
  if(mes==0){mes='01';} else if(mes==1){mes='02';}  else  if(mes==2){mes='03';} else  if(mes==3){mes='04';} else  if(mes==4){mes='05';}
  else  if(mes==5){mes='06';} else  if(mes==6){mes='07';} else  if(mes==7){mes='08';} else  if(mes==8){mes='09';} else  if(mes==9){mes='10';} else if(mes==10){mes='11';} else  if(mes==11){mes='12';}

  if(dia==1){dia='01';}else if(dia==2){dia='02';} else  if(dia==3){dia='03';} else  if(dia==4){dia='04';} else  if(dia==5){dia='05';}
  else  if(dia==6){dia='06';} else  if(dia==7){dia='07';} else  if(dia==8){dia='08';} else  if(dia==9){dia='09';}

  if(h==1){h='01';}else if(h==2){h='02';} else  if(h==3){h='03';} else  if(h==4){h='04';} else  if(h==5){h='05';}
  else  if(h==6){h='06';} else  if(h==7){h='07';} else  if(h==8){h='08';} else  if(h==9){h='09';} else  if(h==0){h='00';}

  if(m==1){m='01';}else if(m==2){m='02';} else  if(m==3){m='03';} else  if(m==4){m='04';} else  if(m==5){m='05';}
  else  if(m==6){m='06';} else  if(m==7){m='07';} else  if(m==8){m='08';} else  if(m==9){m='09';} else  if(m==0){m='00';}

  if(s==1){s='01';}else if(s==2){s='02';} else  if(s==3){s='03';} else  if(s==4){s='04';} else  if(s==5){s='05';}
  else  if(s==6){s='06';} else  if(s==7){s='07';} else  if(s==8){s='08';} else  if(s==9){s='09';} else  if(s==0){s='00';}
    ...
    $("#list_tools form").each(function(){
         $(this).find('.external-company-tool').each(function(){
             if(pos){
                ...
                {
                    $("#sel_company_tool_"+pos).select2({language: {
                        noResults: function() {
                        return "No hay resultado";
                        },
                        searching: function() {
