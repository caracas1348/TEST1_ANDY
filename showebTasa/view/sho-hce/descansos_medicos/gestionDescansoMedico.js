...
function _init_fnSp3SaludOcupacionalEstadoInicial_DM() { //------------------------------------- ini   _init_fnSp3SaludOcupacionalEstadoInicial() -------------------------------------
  //console.clear();
  //showLoading();
...
function fnSp3CargaFiltroEstadoInicialSaludOcupacional_inc() { //------------------------------------- ini   fnSp3CargaFiltroEstadoInicialSaludOcupacional() -------------------------------------
  ...
  //var url = apiUrlsho+"/api/hce_Get_009_interconsulta_busqueda?code=mlLAeNuPAvTC057apNoiFLG/H/j36XcKY8vYElXN1st3CaLy2eeQ1A==&Gerencia=0&Planta=0&Area=0&Documento=0&Nombres&Apellidos&CodeInterconsultaTraferencia&FechaDesde&FechaHasta&Buscar";
        ...
        //############################## BLOQUE CODIGO INTEGRACION ANDY 10-09-2021 #####################################
         ...
         $('#lb_ho_it_interc ').html('Cargando.....')// lo tiene el otro
          ...
          var g = $('#dat_hc_it_a_cod_interc').val();//dat_hc_it_a_cod_interc
  ...
  var url = apiUrlsho + "/api/hce_Get_017_descanso-medico_busqueda?code=qiLgD8uqGlqrIjk1Y7P1NgNioYJRj/HQvmwq60UFvqerUH4Uz5Nwcw==&IdDescanso=" + a0 + "&Gerencia=" + a + "&Planta=" + b + "&Area=" + c + "&Documento=" + d + "&Nombres=" + e + "&Apellidos=" + f + "&OrigenDescanso=" + g + "&FechaDesde=" + h + "&FechaHasta=" + i + "&Buscar="+j;
  ...
  $.ajax(settings).done(function(response) {
    ...
    if (response.DiagnosticoCIE10.length > 0) { //---------------------------------------------------------------
      ...
      console.log("302 D_IT[]", D_IT);
        ...
        HTMLEXCEL_DESCANSO_SHO = [];
        response.DescansoMedico.map(function(Item) 
        {
          ...
          Mes=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];
                                                        ...
                                                        HTMLEXCEL_DESCANSO_SHO += ` 
                                                         <tr  style="border: 1px !important;color: #000;">
                                                                  ...
                                                                  <th  style="border: 1px !important;">${Item.A_IdDescansoMedico != null ? Item.A_IdDescansoMedico : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${Item.A_DniTrabajador != null ? Item.A_DniTrabajador : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${Item.A_NombreTrabjador != null ? Item.A_NombreTrabjador : "---"}</div></td> 
                                                                  <th  style="border: 1px !important;">${Item.A_ApellidosTrabajador != null ? Item.A_ApellidosTrabajador : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${GerenciaId_Empresa_H != null ? GerenciaId_Empresa_H : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${SedeId_Empresa_H_S != null ? SedeId_Empresa_H_S : "---"}</div></td>

                                                                  <th  style="border: 1px !important;">${AreaId_Empresa_H_S != null ? AreaId_Empresa_H_S : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${Item.A_PuestoTrabajo != null ? Item.A_PuestoTrabajo : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${f1 != null ? f1 : "---"}</div></td>
                                                                

                                                                  <th  style="border: 1px !important;"> ${Item.A_Empresa != null ? Item.A_Empresa : "---"}</div></td>  
                                                                  <th  style="border: 1px !important;"> ${Item.DescripcionOrigen != null ? Item.DescripcionOrigen : "---"}</div></td> 

                                                                  <th  style="border: 1px !important;">${Item.A_IdAtencionMedica != null ? Item.A_IdAtencionMedica : "---"}</div></td>  
                                                                  <th  style="border: 1px !important;">${Mes[im] != null ? Mes[im] : "---"}</div></td>  
                                                                  <th  style="border: 1px !important;">${Year != null ? Year : "---"}</div></td>  
                                                                  <th  style="border: 1px !important;">${f_ini != null ? f_ini : "---"}</div></td>  
                                                                  <th  style="border: 1px !important;">${f_fin != null ? f_fin : "---"}</div></td>
                                                                  <th  style="border: 1px !important;">${Item.B_CantidadDias != null ? Item.B_CantidadDias : "---"}</div></td>  
                                                                  <th  style="border: 1px !important;">${Item.B_DiasAcumulados != null ? Item.B_DiasAcumulados : "---"}</div></td>  
    ...
    if (response.DescansoMedico.length > 0) {
      ...
      $('#cant_interc').html('0 registros');
      $('#lb_ho_it_interc').html('Registros sistema SHO')// lo tiene el otro
    ...
    var menupop = `                   <div class="dropdown">
                                          <button class=" btn-link dropdown textVertical" style='outline:none !important;' id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="dropdown-menu">  
                                                  <a class="dropdown-item" onclick="fnVerDescanzoMedico_HC(${Item.Id}, ${Item.HistoriaClinicaId},500)"><img src="./images/sho/eyeIcon.svg" alt="" />&nbsp;&nbsp; Ver Registro</a>
                                                  <a class="dropdown-item" onclick="AprobarDescansoMedico(${Item.Id}, ${Item.HistoriaClinicaId})"><img src="./images/sho/confirm2.svg"  style='width:15px; height:18px;' alt="" /> &nbsp;&nbsp; Aprobar</a> 
                                                </div>
                                          </div>
                                        </div>
                                      `;
                                                    ...
                                                    <div class="header-tabla px-2 py-3 filaBandeja" style=" width:3620px !important; mmargin-rigth:30px !important; " > 
                                                        ...
                                                        <table border="0"  style=" width:3630px !important;  "  >   
                                                            <tr >
                                                                  ...
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c2TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  >${Item.A_IdDescansoMedico != null ? Item.A_IdDescansoMedico : "---"}</div></td>
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c2TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  >${Item.A_DniTrabajador != null ? Item.A_DniTrabajador : "---"}</div></td>
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  >${Item.A_NombreTrabjador != null ? Item.A_NombreTrabjador : "---"}</div></td> 
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c3TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  >${Item.A_ApellidosTrabajador != null ? Item.A_ApellidosTrabajador : "---"}</div></td>
                                                                  <td  style = 'width: 240px;'  align="center"><div id="c4TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  >${GerenciaId_Empresa_H != null ? GerenciaId_Empresa_H : "---"}</div></td>
                                                                  ...
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c7TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important;' >${Item.A_PuestoTrabajo != null ? Item.A_PuestoTrabajo : "---"}</div></td>
                                                                  ...
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Item.A_Empresa != null ? Item.A_Empresa : "---"}</div></td>  
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Item.DescripcionOrigen != null ? Item.DescripcionOrigen : "---"}</div></td> 

                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Item.A_IdAtencionMedica != null ? Item.A_IdAtencionMedica : "---"}</div></td>  
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Mes[im] != null ? Mes[im] : "---"}</div></td>  
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Year != null ? Year : "---"}</div></td>  
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c9TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${f_ini != null ? f_ini : "---"}</div></td>  
                                                                  <td  style = 'width: 190px;'  align="center"><div id="c9TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${f_fin != null ? f_fin : "---"}</div></td>
                                                                  <td  style = 'width: 180px;'  align="center"><div id="c1TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Item.B_CantidadDias != null ? Item.B_CantidadDias : "---"} </div></td>  
                                                                  <td  style = 'width: 200px;'  align="center"><div id="c1TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Item.B_DiasAcumulados != null ? Item.B_DiasAcumulados : "---"}</div></td>  
...
//############################## BLOQUE CODIGO INTEGRACION ANDY 10-09-2021 #####################################
          ...
          $.ajax(settings).done(function(response) {
           ...
           /*
            ...
            // console.log("302 D_IT3[]", D_IT3);
             ...
             HTMLEXCEL_DESCANSO_SAP = [];
             response.DescansoMedicoSAP.map(function(Item) {
               ...
               $('#dat_hc_it_a_gerencia').val(Item.A_Gerencia)
                      ...
                      Mes=["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];
                              ...
                              HTMLEXCEL_DESCANSO_SAP += `   <tr  style="border: 1px !important;color: #000;">
                                                                                         
                                                                                    <th  style="border: 1px !important;">${Item.IdRegistro != null ? Item.IdRegistro : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.Documento != null ? Item.Documento : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.Nombre != null ? Item.Nombre : "---"}</div></td> 
                                                                                    <th  style="border: 1px !important;">${Item.Apellidos != null ? Item.Apellidos : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.Ocupacion != null ? Item.Ocupacion : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.UnidadOrganizativa != null ? Item.UnidadOrganizativa : "---"}</div></td>

                                                                                    <th  style="border: 1px !important;">${im != null ? im : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${f_ini != null ? f_ini : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${f_fin != null ? f_fin : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.CantidadDeDias != null ? Item.CantidadDeDias : "---"}</div></td>

                                                                                    <th  style="border: 1px !important;">${Item.DiasAcumulados != null ? Item.DiasAcumulados : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.AltaMedica == 0 ? 'No' : "Si"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.DescripcionContigencia != null ? Item.DescripcionContigencia : "---"}</div></td>
                                                                                    <th  style="border: 1px !important;">${Item.ExisteEnSHO == 1 ? 'Si' : "No"}</div></td>
        ...
        function fnSp3ListarTablaGeneralH_trans(data) 
        { //------------------------------------------------------- ini   fnSp3ListarTablaGeneralH_trans() -----------------------------------
                  ...
                  data.forEach((Item) => {
                    ...
                    paObj_DM_SAP[Item.Id] = new DescansoMedico();
                    paObj_DM_SAP[Item.Id].cargarData(Item);


                    // var i = paObj_DM_SAP[Item.Id].a.DiagnosticoCIE10.length;
                    // paObj_DM_SAP[Item.Id].a.DiagnosticoCIE10 = D_IT2[Item.Id];
                    //paObj_DM_SAP[Item.Id].a.SignosVitales = D_IT3[Item.Id];


                    console.log("####################################################", Item.Id, "###################################################################")

                    //console.log("paObj_DM_SAP[Item.Id].a.DiagnosticoCIE10 = ", paObj_DM_SAP[Item.Id].a.DiagnosticoCIE10);
                    //console.log("paObj_DM_SAP[Item.Id].a.SignosVitales = ", paObj_DM_SAP[Item.Id].a.SignosVitales);

                    console.log("####################################################", Item.Id, "#######################################################################")

                    // if (paObj_DM_SAP[Item.Id].a.DiagnosticoCIE10) {
                    //   var Diagnostico = paObj_DM_SAP[Item.Id].a.DiagnosticoCIE10.Descripcion_TipCie10;
      ...
      OBJ_I.Sedes.map(function(item) {
        ...
        if (n == nk) { //-----------------------------------------------------------------------
          ...
          OBJ_I.Area.map(function(item) {
             if(OBJ_I.Area.includes(item.Description))
             {
              álert('Ya esta repetido = '+item.Description)
             }
            //$("#" + 'dat_hc_it_a_area').append(`<option value='${item.Id}' title='${item.Description}' style='font-weight: bold;'>${item.Description}</option>`);
            $("#" + 'dat_int_tran_area').append(`<option value='${item.Id}' title='${item.Description}' style='font-weight: bold;'>${item.Description}</option>`);
            mk++;
...
function fnExcelReportPAHC() {
  ...
  var tab_text = `
    ...
    <table  cellpadding="0" cellspacing="0" id="sheet0" style="table-layout: fixed;">
        <thead>
          ...
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">ID Descanso</th> 
          ...
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Puesto de Trabajo</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Fecha de Registro</th>  

          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Empresa</th>  
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Origen del descanso</th>  
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">ID de atención médica</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Mes</th>  
            
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Año</th>  
         
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Fecha Inicio</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Fecha Fin</th>

          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Días de descanso</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Días Acumulados</th>
  ...
  tab_text = tab_text + HTMLEXCEL_DESCANSO_SHO;
  ...
  link.download = 'ListadoDescansosMedicos_SHO';
  link.click();
}
...
function fnExcelReportPAHC2() {
  ...
  var tab_text = `
    ...
    <table  cellpadding="0" cellspacing="0" id="sheet0" style="table-layout: fixed;">
        <thead>
           ...
           <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">ID Registro</th> 
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Documento</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Nombres</th> 
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Apellidos</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Ocupacion</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Unidad Organizativa</th>

          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Mes</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Del</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Al</th>  

          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Dias</th>  
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Dias Acumulados</th>  
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Tipo de Contingencia</th>
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Establecimento de Emision DM</th>  
            
          <th bgcolor='#223962' style="border: 0px !important; color:#ffffff; ">Existe en SHO</th>  
  ...
  tab_text = tab_text + HTMLEXCEL_DESCANSO_SAP;
  ...
  link.href = 'data:application/vnd.ms-excel;base64,' + window.btoa(tab_text);
 link.download = 'ListadoDescansosMedicos_registro_SAP';
  link.click();
}
...
//   //codigo eliminado
//    alert('desde gestion descanso un llamado vacio')
// }
...
function _init_fnSp3SaludOcupacionalEstadoInicial_DM_HC() { //------------------------------------- ini   _init_fnSp3SaludOcupacionalEstadoInicial() -------------------------------------
  //console.clear();
  //showLoading();
...
function cargarAreasSedesGerencia_DM_() {
...
function cargarAreasSedesGerencia_DM_HC() {
...
function fnSp3CargaFiltroEstadoInicialSaludOcupacional_Bandeja_DM() 
{ //------------------------------------- ini   fnSp3CargaFiltroEstadoInicialSaludOcupacional() -------------------------------------
  showLoading();

//alert('estamos desde aqui')
    ...
    //var url = apiUrlsho + "/api/hce_Get_013_Descanso_medico?code=2JQahvuiBVQRE9NUEnh52Osh42wL6WqsypIbRfC6ddhAZGmj2jF14g==&IdHC="+idHC+"&IdDescM=0";
...
//HistoriaClinicaId
    ...
    if (DescansoMedicoTemp.length > 0) {
      $('#cant_interc').html('' + DescansoMedicoTemp.length + ' registros');


      $('#bodyTablaSinAuditorias_int').css('display', 'none');

      $('#pagination-container-EvalAud_int').pagination({
        dataSource: DescansoMedicoTemp,
        pageSize: 2,
        callback: function(data, pagination) {
...
function fnSp3ListarTablaGeneral_BandejaDM(data) 
{ //------------------------------------------------------- ini   fnSp3ListarTablaGeneralH() -----------------------------------
  ...
  data.forEach((Item) => {
     ...
     if(idHC == Item.HistoriaClinicaId)
            {//######################################################_ if(idHC == itemx.HistoriaClinicaId)_################################################################
                        paObj_DM_SHO[Item.Id] = new DescansoMedico();
                        paObj_DM_SHO[Item.Id].cargarData(Item);
...
function fnVerDescanzoMedico_HC(idDescanso, idClinica,accionExtra)
{//-------------------------------------------------------------   fnVerDescanzoMedico_HC($idDescanso, idClinica)  --------------------------------------------------------------
  ...
  //cargamos en la vista por el handler el nuevo formulario
    ...
    //alert('linea 4099 el descanzo medico es ='+id_DM)
    //cargar las listas desplegables
    fnSp3Carga_Listas_Desplegables_DM();//DENTRO DE ELLA LLAMAMOS A CARGAR LOS DATOS PERSONALES
...
function fnNuevoDescanzoMedico_HC()
{//-------------------------------------------------------------   fnNuevoDescanzoMedico_HC($idDescanso, idClinica)  --------------------------------------------------------------
  ...
  //cargamos en la vista por el handler el nuevo formulario
    ...
    fnSp3Carga_Listas_Desplegables_DM();
...
function fnCargarDataPersonal_DM(idClinica, idDescanso)
{

 //alert('entrando a cargar los datos');
  //console.clear();
  console.log('######################################################## fnCargarDataPersonal_DM  #############################################');
  console.log('fnCargarDataPersonal_DM idclinica = ', idClinica);
  console.log('fnCargarDataPersonal_DM id descanso = ', idDescanso);

  console.log('paObj_hc = ', paObj_hc[idClinica]);
  console.log('paObj_DM_SHO = ', paObj_DM_SHO[idDescanso].a);
  ...
  console.log('######################################################## fnCargarDataPersonal_DM  #############################################');
         ...
         $('#dat_des_apellidos_trabajador_v').val(paObj_hc[idClinica].a.Apellidos_Trabajador_H);
          ...
          var f1 = date_AAAA_MM_DD_T_HH_MM_S_to_DD_MM_AAAA(paObj_DM_SHO[idDescanso].a.A_FechaRegistro);
         $('#dat_des_fr_v').val(f1);

         $('#dat_des_fi_v').val(paObj_DM_SHO[idDescanso].a.A_IdDescansoMedico);

         $('#dat_des_empresa_v').val(paObj_DM_SHO[idDescanso].a.A_Empresa);

         $('#dat_des_origen_v').val(paObj_DM_SHO[idDescanso].a.A_Origen);

         $('#dat_des_id_descanso_med_v').val(paObj_DM_SHO[idDescanso].a.A_IdDescansoMedico);
         ...
         $('#dat_des_personal_salud_v').val(paObj_DM_SHO[idDescanso].a.B_PersonalSolicitud);
         $('#dat_des_tipo_contingencia_v').val(paObj_DM_SHO[idDescanso].a.B_TipoContingencia);
         $('#dat_des_descanso_enfermedad_v').val(paObj_DM_SHO[idDescanso].a.B_DescansoPorEnfermedad);
         $('#dat_des_cmp_v').val(paObj_DM_SHO[idDescanso].a.B_CMP);
         $('#dat_des_cant_dias_v').val(paObj_DM_SHO[idDescanso].a.B_CantidadDias);
         $('#dat_des_dias_ac_v').val(paObj_DM_SHO[idDescanso].a.B_DiasAcumulados);
 

         var f2 = date_AAAA_MM_DD_T_HH_MM_S_to_DD_MM_AAAA(paObj_DM_SHO[idDescanso].a.B_FechaIni); //alert(f2);
         $('#dat_des_fi_v2').val(f2);
         
         var f3 = date_AAAA_MM_DD_T_HH_MM_S_to_DD_MM_AAAA(paObj_DM_SHO[idDescanso].a.B_FechaFin)
         $('#dat_des_ff_v').val(f3); 



         $('#dat_des_alta_med_v').val(paObj_DM_SHO[idDescanso].a.B_HuboAltaMedica);
         $('#dat_des_establecimiento_emisión_v').val(paObj_DM_SHO[idDescanso].a.IdEstEmisDesc);
         $('#dat_des_particular_v').val(paObj_DM_SHO[idDescanso].a.B_PersonalSolicitud);
      

         hideLoading();

         interSp3CargarAdjunto_Ver_DM(idDescanso)

         interSp3CargarAdjunto_Ver_DM2(idDescanso)
...
function fnSp3Carga_Listas_Desplegables_DM() { //--------------------------------------------------------------------------------------------------------------  ini ------------------------- fnSp3CargaListasHistoriaClinica_Interconsulta_transferencia
        ...
        // SeccionAfectada
                  ...
                  if(response1.TipoCIE10.length > 0)
                  {
                    ...
                    for(let i=0; i< 100; i++)
                     ...
                     //$("#" + id1).append(`<option value='${item.Id}' title='${item.Especilidades}' style='font-weight: bold;'>ooooo${item.Descripcion}</option>`);
                                 ...
                                 if(response1.SeccionAfectada.length > 0)
                                      {
                                        ...
                                        //alert(' 4308   newd = '+newD);
                                         if(newD == 0)
                                               {
                                                   fnCargarDataPersonal_DM(idHC, id_DM)
                                               }
                                        else
                                            {
...
function interSp3CargarAdjunto_Ver_DM(idTransf)
  {
      //idTransf = 1;
      showLoading();
      ...
      $.ajax(settings).done(function(response1)
       {
          console.log("**interSp3CargarAdjunto_Ver_DM**", response1);
                    ...
                    if(response1.AdjuntoInterconsult.length > 0)
                    {
                      response1.AdjuntoInterconsult.map(function(Item)
                      {
                       // alert('entre aqui 1167')
                        ...
                        paObj_DM_SHO[idTransf].a.Adjuntos[Item.Id] = Item;
                        var f1a = date_AAAA_MM_DD_T_HH_MM_S_to_DD_MM_AAAA(Item.CreadoFecha);
                        tabla3 += `
                            <tr>
                                <td>${Item.NombreArchivo != null ? Item.NombreArchivo : "---"}</td>
                                ...
                                <td>
                                  <button type="button" class="btn btn-link shadow-none float-right">
                                      <img class="inject-svg" src="./images/sho/download.svg" alt="" fill="#8fbb02" width="16px" onclick = 'fnSp3mostrarAdjunto_DM(1,${Item.Id})' title='Descargar Adjunto' > 
                                  </button>
                                </td>
...
function interSp3CargarAdjunto_Ver_DM2(idTransf)
  {
     // idTransf = 1;
      showLoading();
      $('#lb_ad_transf ').html('Cargando.....')
      ...
      $.ajax(settings).done(function(response1)
       {
          console.log("**interSp3CargarAdjunto_Ver_DM2**", response1);
...
console.log('soy yo chamoooooooooooooooooooo');
         ...
         $('#lb_diag_1_int').html(""+ikk+" registros");
          ...
          console.log('********************  lt1['+Item.CIE10+'] = ',lt1[Item.CIE10])
           ...
           diag_DN = diag_DN +' '+Item.Diagnostico //+' '+b+', ';
              ...
              // alert("es aqui 4927 = "+Item.Diagnostico);
                          tabla += `
                            <tr>
                              <td>${Item.Diagnostico != null ? Item.Diagnostico : "---"}</td>
                              <td>${b != null ? b : "---"}</td>
    ...
    function fnSp3mostrarAdjunto_DM(modulo, i)
    {//--------------------------------------------------------------------------------------------------------
        ...
        switch(modulo)
        {
          ...
          case 1://transferencia
                 console.log('datsos del adjunto', paObj_DM_SHO[id_DM].a.Adjuntos);
                //console.log(paObj_ht[istAud].a.Adjuntos[i]);

                 url = paObj_DM_SHO[id_DM].a.Adjuntos[i].ArchivoBase64;//"data:application/msword;base64," + x[1];
                fetch(url)
                .then(res => res.blob())
                .then(function(blob) {
                  downloadBlob(blob, paObj_DM_SHO[id_DM].a.Adjuntos[i].NombreArchivo);
                });
...
function fnSp3CrearNuevo_DM_en_Blanco()
  {//------------------------------------------------------------------------------------------------------------
               ...
               }).done(function (data)
               {
                   ...
                   if(data.Id > 0)
                   {
                      //isNow = 0;
                       ...
                       $('#logoCompany1').html('Registro de Descanso Médico');//cargamos de manera forzada
...
function fnCancelarNuevoDscansoMedico() {
  //hay que borrar en la base de datos si un registro nuevo
           ...
           id_DM; //id de la descanso medico
        if(newD == 1)
        {
...
{//----------------------------------------------------------------------------------------------------------------------
 ...
 console.log('################################################################################################', paObj_DM_SHO[idDescanso])

 if(paObj_DM_SHO[idDescanso].a.A_Estado == "Pendiente aprobación")
 {
       Swal.fire({
              title: "Aprobar Descanso Médico",
              html: `
              <p>Está por aprobar el descanso medico  </p>
              <p><b> (${paObj_DM_SHO[idDescanso].a.A_IdDescansoMedico})</b></p>
              <p class="mt-5">¿Desea confirmar la acción?</p>`,
              icon: "info",
              showCancelButton: true,
              reverseButtons: true,
 ...
 {
    if(paObj_DM_SHO[idDescanso].a.A_Estado == "Aprobado")
     {
         Swal.fire({
          title: "Este Descanso Medico ("+paObj_DM_SHO[idDescanso].a.A_IdDescansoMedico+") <p> ya se encuentra Aprobado <p>",
          icon: 'info',
         /// iconColor: "#ffba00",
                                 ...
                                 var body = {
                                  ...
                                  console.log('urlr:', url)
                                         ...
                                         }).done(function (data)
                                         {
                                             ...
                                             {
                                                   Swal.fire({
                                                                title: "El Descanso Medico ("+paObj_DM_SHO[idDescanso].a.A_IdDescansoMedico+") se aprobado correctamente",
                                                                iconColor: "#8fbb02",
                                                                iconHtml: '<img src="./images/sho/check.svg" width="28px">',
                                                                showConfirmButton: false,
                                                                padding: "3em 3em 6em 3em ",
...
function fnSprint3CuadreManual(HistClinica, idSap)
{
 ...
 //console.log('####################################__5890__############################################################', paObj_DM_SAP[idSap])
...
function fnSp3Carga_Listas_Contingencia_SAP()
 { //--------------------------------------------------------------------------------------------------------------  ini ------------------------- fnSp3CargaListasHistoriaClinica_Interconsulta_transferencia
    ...
    $.ajax(settings).done(function(response1) 
     {
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------------------------
           ...
           $('#dat_des_dni_trabajador').val(paObj_DM_SAP[id_DM_SAP].a.Documento);
           $('#dat_des_nombres_trabajador').val(paObj_DM_SAP[id_DM_SAP].a.Nombre);
           $('#dat_des_apellidos_trabajador').val(paObj_DM_SAP[id_DM_SAP].a.Apellidos);
           $('#dat_des_ocupacion').val(paObj_DM_SAP[id_DM_SAP].a.Ocupacion);
           $('#dat_des_fi').val(date_AAAA_MM_DD_T_HH_MM_S_to_DD_MM_AAAA(paObj_DM_SAP[id_DM_SAP].a.FechaIni));
           $('#dat_des_ff').val(date_AAAA_MM_DD_T_HH_MM_S_to_DD_MM_AAAA(paObj_DM_SAP[id_DM_SAP].a.FechaFin));
           $('#dat_des_dias').val(paObj_DM_SAP[id_DM_SAP].a.CantidadDeDias);
           $('#dat_des_acumulado').val(paObj_DM_SAP[id_DM_SAP].a.DiasAcumulados);
           $('#dat_des_puesto').val(paObj_DM_SAP[id_DM_SAP].a.Ocupacion);
           $('#dat_des_contingenci').val(paObj_DM_SAP[id_DM_SAP].a.TipoContingencia);
...
function fnSp3CargaFiltroEstadoInicialSaludOcupacional_Bandeja_DM_SAP() 
{ //------------------------------------- ini   fnSp3CargaFiltroEstadoInicialSaludOcupacional() -------------------------------------
  showLoading();
    var html = '';
    var k = 0;
      ...
      $.ajax(settings).done(function(response) 
      {
        ...
        if (response.DiagnosticoCIE10.length > 0) { //---------------------------------------------------------------
           ...
           response.DiagnosticoCIE10.map(function(item) 
          {
            ...
            if((item.Diagnostico!=undefined)&&(item.Diagnostico!='undefined'))
            {
              D_IT[item.DescansoMedicoId] =  D_IT[item.DescansoMedicoId] +', '+item.Diagnostico;
              D_IT[item.DescansoMedicoId] =  D_IT[item.DescansoMedicoId].replace('undefined', 'Ninguno');
            }
    ...
    if (response.DescansoMedico.length > 0) 
    {
        ...
        response.DescansoMedico.forEach((Item) => {
           ...
           console.log("**er diagnostico------------------------- andy == ", D_IT[Item.Id]);
                        ...
                        {
                            rd_bt =`<img  src="images/sho/confirm3_off.svg" id = "bt_img_${Item.Id}" style = "width: 22px; cursor:pointer; "   alt = "Vincular con este descanso" onclick="fnSp3Vincular_DM_SAP(${Item.Id},${id_DM_SAP});" >`;
                        }
                        else
                        {
                          if(Item.ExisteEnSAP == 1)
                             { 
                              rd_bt = `<img "bt_img_${Item.Id}"  src="images/sho/confirm3_on.svg" onclick="fnSp3Vincular_DM_SAP(${Item.Id},${id_DM_SAP});"  style = "width: 22px; cursor:pointer; "   alt = "Descanso Vinculado" >`;
                              ult_DMV = 'bt_img_'+Item.Id; 
...
function fnSp3Vincular_DM_SAP(IdDesc,idSAP)
{
...
for(let i = 0; i<ttemp.length; i++)
{
           ...
           console.log("****************************** vamos a vincular DM="+IdDesc+",                    con   SAP = "+idSAP+"            paObj_DM_SHO = "+ttemp);
  ...
  $('#'+id).attr('src','images/sho/confirm3_onBD.svg');
      ...
      if (result.isConfirmed) {
          ...
          //---------------------------------------------------------------------------------------------------------------------
                            ...
                            //---------------------------------    Si es diferente desvincular y luego vincular el nuevo -------------------------------------
                                       ...
                                       if((Vinculado != id_DM)&&(Vinculado > 0))
                                       {//-----------------------------------------------------------------------------------------------------------------
                                          // alert("hay que desvincular esto primero id_DM ="+id_DM+"              vinculado = "+Vinculado);
            
                                             var body = {
                                                        "IdDescMedSHO": Vinculado, 
                                                        "IdDescMedSAP":id_DM_SAP
                                                      }
                                                                                    ...
                                                                                    var body = {
                                                                                        ...
                                                                                        console.log('urlr:', url)
                                                                                               ...
                                                                                               }).done(function (data)
                                                                                               {
                                                                                                   ...
                                                                                                   {
                                                                                                         Swal.fire({
                                                                                                                      title: "Se Vinculo correctamente  descanso medico ("+paObj_DM_SHO[id_DM].a.A_IdDescansoMedico+") con el registro SAP",
                                                                                                                      iconColor: "#8fbb02",
                                                                                                                      iconHtml: '<img src="./images/sho/check.svg" width="28px">',
                                                                                                                      showConfirmButton: false,
                                                                                                                      padding: "3em 3em 6em 3em ",
...
function fnSp3ImprimirDescanso()
{//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  if(newD == 0)
  {
      desSp3ImprimirDescanso_Ver();
  }
  else
  {
      desSp3ImprimirDescanso();
  }
...
function desSp3ImprimirDescanso_Ver() {
  ...
  let planta =  $('#dat_des_planta_v option:selected').text().toUpperCase(); 
  let medico = $('#dat_des_personal_salud_v').val();
 
  let cmp = $('#dat_des_cmp_v').val();
  let nombres_b = $('#dat_des_nombres_trabajador_v').val();
  let apellidos_b = $('#dat_des_apellidos_trabajador_v').val();
  let dni = $('#dat_des_dni_trabajador_v').val();

  let cargo_x = $('#dat_des_id_atencion_med_v').val();
  let area_trabajo =  $('#dat_des_area_v option:selected').text(); 
  let diagnostico = diag_DN; //falta---------------------------------------------************************ recorrer el array

  
  let indica = $('#dat_des_cant_dias_v').val();


  let fecha_inicio = $('#dat_des_fi_v2').val();
  let fecha_inicio1 = $('#dat_des_fi_v2').val();
      fecha_inicio1 = fecha_inicio1.split('/');

//alert($('#dat_des_fi_v2').val());


  let dia_a = fecha_inicio1[0]
  let mes_a = fecha_inicio1[1]
  let ano_a = fecha_inicio1[2]

  // let dia_a = moment(fecha_inicio).format('DD');
  // let mes_a = moment(fecha_inicio).format('MM');
  // let ano_a = moment(fecha_inicio).format('YYYY');

  let fecha_fin = $('#dat_des_ff_v').val();
  let fecha_fin1 =$('#dat_des_ff_v').val();
      fecha_fin1 = fecha_fin1.split('/');
  let dia_b = fecha_fin1[0];
  let mes_b = fecha_fin1[1];
  let ano_b = fecha_fin1[2];
 ...
 // doc.output('dataurlnewwindow');
  doc.save(`Descanso_${nombres_b}_${apellidos_b}`);
...
function desSp3ImprimirDescanso() {
 ...
 if (Sp3ValidarDatos('input_am_descanso').length > 0) 
 {
  ...
  let dia_a = fecha_inicio1[2]
  let mes_a = fecha_inicio1[1]
  let ano_a = fecha_inicio1[0]
  ...
  let fecha_fin1 =$('#dat_des_ff_v').val();
      fecha_fin1 = fecha_fin1.split('-');
  let dia_b = fecha_fin1[2];
  let mes_b = fecha_fin1[1];
  let ano_b = fecha_fin1[0];

///alert($('#dat_des_ff_v').val());
...
function amSp3CalcularDiasAcumulados_DM() {
  let cantidadDias = Number($('#dat_des_cant_dias_v').val()) + 1;
  let fechaInicio = $('#dat_des_fi_v2').val();
  ...
  if (cantidadDias && fechaInicio) {
    ...
    let fechaFin = `${fechaResult.getFullYear()}-${("0" + (fechaResult.getMonth()+1)).slice(-2)}-${("0" + fechaResult.getDate()).slice(-2)}`;

    $('#dat_des_ff_v').val(fechaFin);
    $('#dat_des_dias_ac_v').val(cantidadDias);
