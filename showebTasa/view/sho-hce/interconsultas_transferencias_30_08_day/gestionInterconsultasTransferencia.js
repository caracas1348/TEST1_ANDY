...
{//--------------------------------------------------------------------------------------------------------------  ini ------------------------- fnSp3CargaListasHistoriaClinica_Interconsulta_transferencia
  ...
  $.ajax(settings).done(function(response1) {
      ...
      $("#" + 'dat_hc_it_a_gerencia').css('font-size', '13px'); //lecciones aprendidas
        ...
        lk++;
           if(l == lk)
              {//----------------------------------------------------------------------------------------------------------
                    ...
                    $("#" + 'dat_hc_it_a_planta_sede').css('font-size', '13px'); //lecciones aprendidas
                      ...
                      $("#" + 'dat_hc_it_a_planta_sede').append(`<option value='${item.Id}' title='${item.Description}' style='font-weight: bold;'>${item.Description}</option>`);
                        nk++;
                          ...
                          {//-----------------------------------------------------------------------
                                    ...
                                    $("#" + 'dat_hc_it_a_area').css('font-size', '13px'); //lecciones aprendidas
                                                        ...
                                                        <table border="0"  style=" width:3030px !important;  "  >   
                                                            <tr >
                                                                  ...
                                                                  <td  style = 'width: 190px;'  align="center"><div id="c9TabGenyx" class="text-center lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${Item.B_RecibioRespuesta_Inter == 1 ? 'Si' : "No"}</div></td>  
                                                                   <!-- <td  style = 'width: 190px;'  align="center"><div id="c9TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > xxx${Item.C_ActitupParaLaboral_Inter == 1 ? 'Apto' : "No Apto"}</div></td>  -->
                                                                  <td  style = 'width: 180px;'  align="center"><div id="c1TabGenyx" class="text-left lbCabezaTabla" style = 'color:#1C1C1C  !important; '  > ${D_IT2[Item.Id] != null ? D_IT2[Item.Id] : "---"} </div></td>  
